...
@router.post('')
async def create_task(payload: CreateTask, task_service: TaskService = Depends(get_task_service)):
...
async def get_task(task_id: UUID, payload: UpdateTask, task_service: TaskService = Depends(get_task_service)):
